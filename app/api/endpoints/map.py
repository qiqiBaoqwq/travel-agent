...
async def search_poi(
    ...
    try:
        ...
        return AppResponse.success(data=pois, message="POI搜索成功")
...
@router.get(
    "/weather",
    response_model=AppResponse[List[WeatherInfo]],
    summary="查询天气",
...
async def get_weather(
    ...
    try:
        ...
        return AppResponse.success(data=weather_info, message="天气查询成功")
...
@router.post(
    "/route",
    response_model=AppResponse[RouteInfo],
    summary="规划路线",
...
async def plan_route(request: RouteRequest):
    ...
    try:
        ...
        return AppResponse.success(data=route_info, message="路线规划成功")
